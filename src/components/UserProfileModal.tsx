...
export const UserProfileModal: React.FC<UserProfileModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-3 sm:p-4 bg-black/40 dark:bg-black/70 backdrop-blur-md animate-fade-in">
      <div className="bg-stone-50/95 dark:bg-stone-900/95 text-stone-900 dark:text-stone-100 border border-stone-200/80 dark:border-stone-800 shadow-2xl rounded-[28px] max-w-md w-full p-5 space-y-4 relative overflow-hidden backdrop-blur-2xl max-h-[85vh] flex flex-col justify-between">
        ...
        <div className="flex items-center justify-between shrink-0 px-1 pt-1">
          <h2 className="text-lg font-extrabold tracking-tight text-stone-900 dark:text-stone-100">
            Ayarlar
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="overflow-y-auto space-y-4 pr-0.5 font-sans flex-1">
          ...
          {/* Profile Card */}
          <div className="bg-white dark:bg-stone-800/80 border border-stone-200/70 dark:border-stone-700/60 rounded-2xl p-3.5 flex items-center justify-between shadow-2xs">
            {currentUser ? (
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-stone-100 dark:bg-stone-700 flex items-center justify-center text-stone-500 dark:text-stone-300 shrink-0">
          ...
          {errorMessage && (
            <div className="p-3 bg-rose-50 dark:bg-rose-950/80 border border-rose-200 dark:border-rose-800 text-rose-800 dark:text-rose-200 rounded-xl text-xs font-medium">
              {errorMessage}
            </div>
          )}

          {domainError && (
            <div className="p-3 bg-amber-50 dark:bg-stone-800 border border-amber-300 dark:border-amber-700 text-amber-950 dark:text-amber-200 rounded-xl text-xs space-y-2">
          ...
          <div className="space-y-1">
            ...
            <div className="bg-white dark:bg-stone-800/80 border border-stone-200/70 dark:border-stone-700/60 rounded-2xl p-3 space-y-3 shadow-2xs">
              ...
              <div className="flex items-center justify-between text-xs">
                ...
                <div className="inline-flex p-0.5 bg-stone-100 dark:bg-stone-900 rounded-xl border border-stone-200/80 dark:border-stone-700">
                  {[
              ...
              <div className="flex items-center justify-between text-xs pt-2.5 border-t border-stone-100 dark:border-stone-700/50">
                ...
                <div className="flex items-center gap-1.5">
                  {[
                    ...
                    >
                      {pageTheme === theme.id && <Check className="w-3 h-3 text-emerald-700 dark:text-emerald-400 shrink-0" />}
                    </button>
                  ))}
                </div>
              </div>
          ...
          <div className="space-y-1">
            ...
            <div className="bg-white dark:bg-stone-800/80 border border-stone-200/70 dark:border-stone-700/60 rounded-2xl p-3 divide-y divide-stone-100 dark:divide-stone-700/50 text-xs shadow-2xs">
          ...
          {onStartTour && (
            ...
            >
              <span className="font-semibold text-stone-800 dark:text-stone-200 flex items-center gap-2">
                <span>🧭</span> Uygulama Turunu Başlat
              </span>
