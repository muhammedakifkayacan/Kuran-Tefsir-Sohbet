        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
          {filteredSessions.map((session) => (
            <motion.div
              ...
              className="bg-white dark:bg-stone-900 rounded-3xl p-5 border border-stone-200/90 dark:border-stone-800 shadow-2xs hover:border-emerald-500/40 dark:hover:border-emerald-500/40 transition-all flex flex-col justify-between space-y-4 group"
            >
              ...
              <button
                ...
                className="w-full mt-2 py-2.5 px-4 rounded-2xl bg-stone-100 dark:bg-stone-800 hover:bg-emerald-700 hover:text-white dark:hover:bg-emerald-600 text-stone-800 dark:text-stone-200 text-xs font-bold transition-all flex items-center justify-between cursor-pointer group-hover:bg-emerald-700 group-hover:text-white dark:group-hover:bg-emerald-600"
              >
